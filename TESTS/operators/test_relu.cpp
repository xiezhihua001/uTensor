...
TEST(ReLU, random_inputs_float_0) {
  ...
  ReLU
       .set_inputs({ {InPlaceReLU<float>::x, io}})
       .eval();
...
TEST(ReLU, random_inputs_int8_t_0) {
  ...
  ReLU
       .set_inputs({ {InPlaceReLU<int8_t>::x, io}})
       .eval();
...
TEST(ReLU, random_inputs_int16_t_0) {
  localCircularArenaAllocator<1024> meta_allocator;
  localCircularArenaAllocator<784*2*sizeof(int16_t), uint32_t> ram_allocator;
  Context::get_default_context()->set_metadata_allocator(&meta_allocator);
  Context::get_default_context()->set_ram_data_allocator(&ram_allocator);
  ...
  ReLU
       .set_inputs({ {InPlaceReLU<int16_t>::x, io}})
       .eval();
...
TEST(ReLU, random_inputs_int32_t_0) {
  localCircularArenaAllocator<1024> meta_allocator;
  localCircularArenaAllocator<784*2*sizeof(int32_t), uint32_t> ram_allocator;
  Context::get_default_context()->set_metadata_allocator(&meta_allocator);
  Context::get_default_context()->set_ram_data_allocator(&ram_allocator);
  ...
  ReLU
       .set_inputs({ {InPlaceReLU<int32_t>::x, io}})
       .eval();
